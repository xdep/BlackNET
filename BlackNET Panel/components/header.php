  <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item <?php if(strpos(urlencode(htmlentities($_SERVER['REQUEST_URI'])), "index.php")){ echo ("active"); } ?>">
          <a class="nav-link" href="index.php"><span class="fa fa-home"></span> Home</a>
        </li>
        <li class="nav-item <?php if(strpos(urlencode(htmlentities($_SERVER['REQUEST_URI'])), "viewlogs.php")){ echo ("active"); } ?>">
          <a class="nav-link" href="viewlogs.php"><span class="fa fa-clipboard-check"></span> View Logs</a>
        </li>
        <li class="nav-item <?php if(strpos(urlencode(htmlentities($_SERVER['REQUEST_URI'])), "settings.php")){ echo ("active"); } ?>">
          <a class="nav-link" href="settings.php"><span class="fa fa-wrench"></span> Settings</a>
        </li>
        <li class="nav-item <?php if(strpos(urlencode(htmlentities($_SERVER['REQUEST_URI'])), "changePassword.php")){ echo ("active"); } ?>">
