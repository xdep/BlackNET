              ...
              <div class="card-body">
                  ...
                  <div class="table-responsive pt-4 pb-4">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th><input <?php if(empty($logs)){echo "disabled";}?> type="checkbox" name="select-all" id="select-all"></th>
                          <th>Time</th>
                          <th>Victim ID</th>
                          <th>Message</th>
                          <th>Status</th>
                      ...
                      <tbody>
                          <?php foreach ($logs as $log): ?>
                            ...
                            <?php if ($log->type == "Succ"): ?>
                              <td><div><span class="fas fa-check text-success"></span></div></td>
                            <?php else: ?>
                              <td><div><span class="fas fa-times text-danger"></span></div></td>
                            <?php endif; ?>
                          </tr>
                          <?php endforeach; ?>
                      </tbody>
